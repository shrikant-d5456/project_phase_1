...
const Createpost = () => {
    ...
    const uploadPost = async () => {
        if (!title || !desc || !img || !user?.id || !user?.username) {
            ...
            const isConfirmed = confirm("Are you sure all this information is correct?");
            ...
            if (isConfirmed) {
                try {
                    ...
                    const resp = await axios.post(`${import.meta.env.VITE__BACKEND_URL}/auth/post/create`, payload, {
                        headers: {
                ...
                alert("Operation canceled, Please Checkout.");
            }
