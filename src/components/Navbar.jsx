    ...
    <header>
      ...
      <div>
        ...
        <div className='flex justify-between items-center p-4'>
          ...
          <div>
            <button className='lg:hidden block text-xl shadow-xl p-2 rounded-md border-[1px] border-gray-200' onClick={() => setmenu(!menu)}>{menu ?  <BsX /> : <BsList /> }</button>
            ...
            {/* {!user &&
              ...
              {user &&
                <>
                  <button onClick={handlelogout} className='flex gap-2 justify-center items-center hover:text-green-800 cursor-pointer'><BsPersonDashFill />Logout</button>
