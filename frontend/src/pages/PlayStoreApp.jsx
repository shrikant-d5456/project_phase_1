...
const PlayStoreApp = () => {
  return (
    <main className=' bg-yellow-50'>
      ...
      <p className=' heading'><span className='uppercase'>AayurMedGuide</span> Home App</p>
