...
const MyCheckedPost = () => {
  ...
  const getposts1 = async () => {
    try {
      const resp = await axios.get(`${URL}/auth/api/post/validator1-checked-post`);
  ...
  const getposts2 = async () => {
    try {
      const resp = await axios.get(`${URL}/auth/api/post/validator2-checked-post`);
      setposts(resp.data.data);
    } catch (err) {
      setError(err.message);
    }
  ...
  const getposts3 = async () => {
    try {
      const resp = await axios.get(`${URL}/auth/api/post/validator3-checked-post`);
      setposts(resp.data.data);
    } catch (err) {
      setError(err.message);
    }
  ...
  const getposts4 = async () => {
    try {
      const resp = await axios.get(`${URL}/auth/api/post/validator4-checked-post`);
      setposts(resp.data.data);
    } catch (err) {
      setError(err.message);
    }
  ...
  const getposts5 = async () => {
    try {
      const resp = await axios.get(`${URL}/auth/api/post/validator5-checked-post`);
      setposts(resp.data.data);
    } catch (err) {
      setError(err.message);
    }
