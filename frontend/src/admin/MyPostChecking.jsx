...
const MyPostChecking = () => {
  ...
  const getposts1 = async () => {
    try {
      const resp = await axios.get(`${import.meta.env.VITE_BACKEND}/auth/api/post/validator1-checking`);
  ...
  const getposts2 = async () => {
    try {
      const resp = await axios.get(`${import.meta.env.VITE_BACKEND}/auth/api/post/validator2-checking`);
      setposts(resp.data.data);
    } catch (err) {
      setError(err.message);
    }
  ...
  const getposts3 = async () => {
    try {
      const resp = await axios.get(`${import.meta.env.VITE_BACKEND}/auth/api/post/validator3-checking`);
      setposts(resp.data.data);
    } catch (err) {
      setError(err.message);
    }
  ...
  const getposts4 = async () => {
    try {
      const resp = await axios.get(`${import.meta.env.VITE_BACKEND}/auth/api/post/validator4-checking`);
      setposts(resp.data.data);
    } catch (err) {
      setError(err.message);
    }
  ...
  const getposts5 = async () => {
    try {
      const resp = await axios.get(`${import.meta.env.VITE_BACKEND}/auth/api/post/validator5-checking`);
      setposts(resp.data.data);
    } catch (err) {
      setError(err.message);
    }
